...
def _offline_response(prompt: str) -> str:
    ...
    if '"currency": "INR"' in prompt:
        ...
        return json.dumps({"currency": "INR", "startup_cost": {"items": [{"name": "Product development", "amount": 350000}, {"name": "Legal and incorporation", "amount": 50000}, {"name": "Launch marketing", "amount": 100000}], "total": 500000}, "monthly_expenses": expenses, "revenue_projection": projection, "break_even_month": 4, "funding_requirement": 1800000, "assumptions": ["Base case assumes 15 new paying customers per month", "Average starting contract value is ₹5,000 per month", "Figures are planning estimates, not audited forecasts"]})
